    ...
    while (1) {
        if (tmrFlag) {
            ...
            EUSART_CompWrite((IO_RCrossD_GetValue() << 7) | (IO_RCrossU_GetValue() << 6) | (IO_RCrossR_GetValue() << 5) | (IO_RCrossL_GetValue() << 4)
                    | (PORTCbits.RC1 << 3) | (PORTCbits.RC5 << 2) | (PORTDbits.RD5 << 1) | (PORTDbits.RD2 << 0));
            EUSART_CompWrite((IO_RLeverSwR_GetValue() << 7) | (IO_RLeverSwL_GetValue() << 6) | (IO_LLeverSwR_GetValue() << 5) | (IO_LLeverSwL_GetValue() << 4)
                    | (IO_RMid_GetValue() << 3) | (IO_RDown_GetValue() << 2) | (PORTDbits.RD6 << 1) | (PORTCbits.RC2 << 0));
            ...
            EUSART_CompWrite((IO_RLeverSwR_GetValue() << 5) | (IO_RLeverSwR_GetValue() << 4) | (IO_RLeverSwR_GetValue() << 3) | (IO_RLeverSwR_GetValue() << 2) | (IO_RLeverSwR_GetValue() << 1) | (IO_RLeverSwR_GetValue() << 0));
       ...
       /* if (EUSART2_DataReady) {
            //subdata.byte = EUSART2_Read();kore
        }*/
